...
| Open src    | [tic80]  | [90s.dev](https://os.90s.dev) <small style='opacity:0.5'>*</small> |
...
<iframe width=640 height=360 src='https://os.90s.dev/#sys/apps/paint.app.js'></iframe>
...
In short, [os.90s.dev](https://os.90s.dev) is a unique new kind of platform for making game makers:
...
and click again to close it: [os.90s.dev/#sys/apps/paint.app.js](https://os.90s.dev/#sys/apps/paint.app.js)
...
so I ended up with
an extremely simple [auto-layout system](https://docs.os.90s.dev/technical/views.html#layout)
...
So [refs](https://docs.os.90s.dev/technical/views.html#refs) gradually emerged,
...
This lead to [composites](https://docs.os.90s.dev/technical/views.html#composites):
...
```ts
import { stuff } from 'https://os.90s.dev/fs/net/someuser/some/file.js'
```
...
```ts
import { stuff } from 'https://os.90s.dev/fs/ghb/someuser/project@1.0.0/some/file.js' // or:
import { stuff } from 'https://os.90s.dev/fs/npm/someuser/project@1.0.0/some/file.js'
```
...
For sharing apps, use the link format `https://os.90s.dev/#app`, e.g.

* [os.90s.dev/#sys/apps/paint.app.js](https://os.90s.dev/#sys/apps/paint.app.js)
* [os.90s.dev/#sys/apps/fontmaker.app.js](https://os.90s.dev/#sys/apps/fontmaker.app.js)
* [os.90s.dev/#sys/apps/spritemaker.app.js](https://os.90s.dev/#sys/apps/spritemaker.app.js)
* `os.90s.dev/#ghb/someuser/someapp.app.js` (coming soon)
* `os.90s.dev/#npm/someuser/someapp.app.js` (coming soon)
